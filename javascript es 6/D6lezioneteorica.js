// alert("ok") x controllare che la pagina sia allegata correttamente a quella dell'HTML

// BOM -> Browser Object MOdel

console.log(window) // oggetto predefinito, puoi accedere alla cronologia del browser dell'utente

// window. alert("sono un alert!")
// let s = window.confirm("Ti piace Javascript?")

// DOM -> Document Object Model = manipolazione della pagina del documento
window.document; // è il percorso in Console per vedere la pagina HTML 

console.log(document) // stampa la pagina HTML
console.dir(document) // stampa le proprietà e i metodi / l'oggetto

// per selezionare un NODO della pagina HTML con un -> #id
document.getElementById('titolo')

let t = document.getElementById('titolo') // dentro una variabile abbiamo applicato la regola per selezionare un NODO specifico #id e manipolarlo
console.log(t)
console.dir(t)
